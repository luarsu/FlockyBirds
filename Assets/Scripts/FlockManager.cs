...
public class FlockManager : MonoBehaviour {
    ...
    public NegativeStimuli nStimuli;
    public PositiveStimuli pStimuli;
    // number of enemies and birds
    public int numFlock;
    public int numEnemies;
    //array for the enemies, birds and stimulus
    public List<flockMember> members;
    public List<InvisibleNegativeStimuli> enemies;
    ...
    void Start () {
        ...
        enemies = new List<InvisibleNegativeStimuli>();
        ...
        enemies.AddRange(FindObjectsOfType<InvisibleNegativeStimuli>());
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0)) {
            ...
            pz.z = 0;
            enemies.Add(Instantiate(nStimuli, pz, Quaternion.identity));
        ...
        if (Input.GetMouseButtonDown(1))
        {
            Vector3 pz = Camera.main.ScreenToWorldPoint(Input.mousePosition);
            pz.z = 0;
            pstimulis.Add(Instantiate(pStimuli, pz, Quaternion.identity));
    ...
    public List<InvisibleNegativeStimuli> GetEnemies(flockMember member, float radius) {
        List<InvisibleNegativeStimuli> returnEnemies = new List<InvisibleNegativeStimuli>();
